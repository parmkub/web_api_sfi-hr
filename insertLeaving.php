...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $enddate = strtotime("+$dayCount day", $startdate);  //วันที่สิ้นสุด
    ...
    while ($startdate < $enddate) {
        ...
        $sql = "INSERT INTO sf_per_absence_mobile (absence_document,absence_date, employee_code, absence_code, absence_day,absence_hour,delete_mark,absence_period,absence_status,absence_detail,absence_token,CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE,LAST_UPDATED_BY)
